...
# Taken from https://github.com/facebookresearch/generalized-schrodinger-bridge-matching/blob/main/gsbm/interp1d.py
...
def linear_interp1d(t, xt, mask, s):
    ...
    left = torch.searchsorted(t[1:].cpu().T.contiguous(), s.cpu().T.contiguous(), side="left").T.to(t.device)
