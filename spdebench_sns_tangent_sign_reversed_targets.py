#!/usr/bin/env python3
"""SNS target-correctness control: sign_reversed_targets.
...
TARGET_CONTROL = "sign_reversed_targets"
...
def parse_args():
    ...
    p.add_argument(
        "--run-root",
        type=Path,
        default=Path("runs/sns_target_ablations/production/sign_reversed_targets"),
    )
